...
### MVCC机制
MVCC机制详见另一篇[文章](https://blog.csdn.net/SnailMann/article/details/94724197)。在这里梳理几个点
- MVCC要解决的问题
- 在mysql中的体现
- 具体的实现（读/写）
- 悲观锁与乐观锁
...
### MYSQL的锁机制
[正确的理解MySQL中让你想到就烦的各种锁（一）](https://blog.csdn.net/SnailMann/article/details/88353099)

主要看图说话
![img](https://s2.ax1x.com/2020/02/28/3ruZYn.png)

### MYSQL的索引机制
[正确的理解MySQL的索引机制以及内部实现](https://blog.csdn.net/SnailMann/article/details/95618910)
